    ...
    if (isBatchRequest) {
      ...
      for (let i = 0; i < prompts.length; i++) {
        ...
        const requestBody = {
          ...
          generationConfig: {
            ...
            maxOutputTokens: isMCQPrompt ? 50 : 150, // Shorter output for MCQs
            topP: 0.95
          }
        };
        ...
        try {
          ...
          // Extract the generated text from the response (Gemini format)
          let generatedText = '';
      ...
      const requestBody = {
        ...
        generationConfig: {
          ...
          maxOutputTokens: isMCQ ? 50 : 150, // Shorter output for MCQs
          topP: 0.95
        }
      };
