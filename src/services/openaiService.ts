...
import { OPENAI_API_KEY, DEFAULT_OPENAI_MODEL, OPENAI_MODELS, API_ENDPOINTS } from '@/config/apiConfig';
 ...
 */
export async function generateOpenAIAnswer(question: string, model: string = DEFAULT_OPENAI_MODEL): Promise<string> {
  try {
