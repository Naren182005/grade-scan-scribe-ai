...
import { analyzeHandwriting, evaluateAnswer, generateAnswerEvaluationJSON, generateHandwritingAnalysisJSON } from '@/utils/evaluationServices';
...
const EvaluationDemo: React.FC = () => {
  ...
  const handleAnalyzeHandwriting = () => {
    ...
    const result = analyzeHandwriting(studentAnswer);
